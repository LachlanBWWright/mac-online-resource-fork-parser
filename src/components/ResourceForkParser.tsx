...
const SAMPLE_DEFINITIONS: SampleDefinition[] = [
  ...
  {
    id: "nanosaur-deinon-skeleton",
    name: "Nanosaur — Deinonychus Skeleton",
    filename: "nanosaur-deinon-skeleton.rsrc",
    path: "/test-files/opensource/pangea/nanosaur-deinon-skeleton.rsrc",
    description: "A resource fork from the open-source Nanosaur port; the port stores its Level 1 terrain as a flat .ter file, so this is its representative skeleton resource.",
    source: "Jorio / Nanosaur",
    category: "Game data",
  },
  {
    id: "bugdom-lawn",
    name: "Bugdom — Lawn Level",
    filename: "bugdom-lawn.rsrc",
    path: "/test-files/opensource/pangea/bugdom-lawn.rsrc",
    description: "The Lawn terrain level from Jorio's open-source Bugdom port.",
    source: "Jorio / Bugdom",
    category: "Game data",
  },
  {
    id: "nanosaur2-level-1",
    name: "Nanosaur 2 — Level 1",
    filename: "nanosaur2-level1.rsrc",
    path: "/test-files/opensource/pangea/nanosaur2-level1.rsrc",
    description: "Level 1 terrain from Jorio's open-source Nanosaur 2 port.",
    source: "Jorio / Nanosaur2",
    category: "Game data",
  },
  {
    id: "billy-frontier-town-shootout",
    name: "Billy Frontier — Town Shootout",
    filename: "billy-frontier-town-shootout.rsrc",
    path: "/test-files/opensource/pangea/billy-frontier-town-shootout.rsrc",
    description: "The Town Shootout terrain level from Jorio's open-source Billy Frontier port.",
    source: "Jorio / BillyFrontier",
    category: "Game data",
  },
  {
    id: "bugdom2-level-1-garden",
    name: "Bugdom 2 — Level 1 Garden",
    filename: "bugdom2-level1-garden.rsrc",
    path: "/test-files/opensource/pangea/bugdom2-level1-garden.rsrc",
    description: "Level 1 Garden terrain from Jorio's open-source Bugdom 2 port.",
    source: "Jorio / Bugdom2",
    category: "Game data",
  },
  {
    id: "cromag-stoneage-jungle",
    name: "Cro-Mag Rally — Stone Age Jungle",
    filename: "cromag-stoneage-jungle.rsrc",
    path: "/test-files/opensource/pangea/cromag-stoneage-jungle.rsrc",
    description: "The Stone Age Jungle terrain level from Jorio's open-source Cro-Mag Rally port.",
    source: "Jorio / CroMagRally",
    category: "Game data",
  },
  {
    id: "dialog",
