...
async function runManualTests() {
    ...
    try {
        ...
        // Upload .rsrc file
        const rsrcPath = (0, path_1.join)(process.cwd(), 'public/test-files/EarthFarm.ter.rsrc');
        ...
        const specsPath = (0, path_1.join)(process.cwd(), 'public/test-files/otto-specs.txt');
